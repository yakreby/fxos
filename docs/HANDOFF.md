...
> Son güncelleme: **2026-06-08** (… + **Octabin** + **Separasyon** + **Excel/PDF/CSV dışa aktarma altyapısı** + UI hızlı düzeltmeler — [`MODULES.md`](MODULES.md))
...
| `AiBubble` | Placeholder panel | Gerçek asistan (belirsiz, sonra) |
| Connection string | `appsettings*.json` içinde (commit'li) | user-secrets / ortam değişkeni |
